...
if ($addtype == "addnews") {
   ...
   {
      $image_upload = "<div class=\"editor_button\" onclick=\"dle_image_upload('{$p_name}', '{$row['id']}'); return false;\"><img title=\"$lang[bb_t_up]\" src=\"{THEME}/bbcodes/upload.gif\" width=\"23\" height=\"25\" border=\"0\" alt=\"\" /></div>";
